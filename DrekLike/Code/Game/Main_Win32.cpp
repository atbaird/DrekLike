...
void Update()
{
	...
	if (g_TheApp != nullptr)
	{
		g_TheApp->SetConsoleIsNull(g_Console == nullptr);
		g_TheApp->SetGameIsNull(g_TheGame == nullptr);
		g_TheApp->Update(deltaSeconds);
	}

	if (g_TheGame != nullptr && g_TheGame->isQuitting() == true)
	{
		g_isQuitting = true;
	}
}
...
void Initialize(HINSTANCE applicationInstanceHandle)
{
	...
	font = new Font("Data/Font/", "DebugFont.fnt");
	g_TheApp->SetFont(font);
	g_Console = new Console(font, false);
