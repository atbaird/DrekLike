...
public:
	...
	void SetVariableLocToValueFourFloatPointer(const int& Value, const float* toSet, const int& numberOfValues = 1) const;
	void SetVariableLocToValueThreeFloatPointer(const int& Value, const float* toSet, const int& numberOfValues = 1) const;
	void SetVariableLocToValueTwoFloatPointer(const int& Value, const float* toSet, const int& numberOfValues = 1) const;
	...
	void SetVariablesLocToValue4By4Matrix(const int& Value, const float* toSet, const bool& transpose = false, const int& numberOfValues = 1) const;
	...
	//VBOs
	const unsigned int DeteremineVBOUsage(const VBOusage& usage);
